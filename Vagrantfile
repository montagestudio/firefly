Vagrant.configure('2') do |config|
    ...
    config.vm.define "load-balancer" do |lb|
        ...
        lb.vm.provision :shell, inline: "cp /vagrant/deploy/files/local-project.montagestudio.com.pem /etc/ssl/local-project.montagestudio.com.pem"
        ...
        lb.vm.provision :shell, inline: "sed -i.bak 's/project.montagestudio.net.pem/local-project.montagestudio.com.pem/' /etc/haproxy/haproxy.cfg"
        #   login
