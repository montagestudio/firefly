...
remove-image "base-project-image-$BUILD_RELEASE_NAME"

echo "***** Building base-project-image-$BUILD_RELEASE_NAME *****"

packer build \
    -var "base_image_id=$BASE_IMAGE_ID" \
    -var "snapshot_name=base-project-image-$BUILD_RELEASE_NAME" \
    "${HOME}/deploy/base-project-image.json"
