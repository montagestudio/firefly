...
var GithubService = require("../services/repository/github")._GithubService;
...
ContainerManager.prototype._getRepoPrivacy = function(details, githubAccessToken) {
    if (details.private === undefined && githubAccessToken) {
        var githubService = new this._GithubService(githubAccessToken);
